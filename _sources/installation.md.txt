...
[win32tools](https://hinetwww11.bosai.go.jp/auth/manual/dlDialogue.php?r=win32tools) is a collection of tools provided by [NIED Hi-net](https://www.hinet.bosai.go.jp/) to process win32 format data. HinetPy needs the `catwin32` and `win2sac_32` commands to process the win32 data.
